...
def mySystemTray(self):
    ...
    self.tray_show_app.setIcon(QIcon(':/monitor_icon.png'))
    
    self.tray_cancel_process = QAction("Cancel Process", self)
    self.tray_cancel_process.setIcon(QIcon(':/cancel_icon.png'))
    ...
    self.tray_start_action.setIcon(QIcon(':/start_icon.png'))
    
    self.tray_break_action = QAction("Break", self)
    self.tray_break_action.setIcon(QIcon(':/break_icon.png'))
    
    self.tray_long_break_action = QAction("Long Break", self)
    self.tray_long_break_action.setIcon(QIcon(':/long_break_icon.png'))
    
    self.tray_quit_action = QAction("Quit", self)
    self.tray_quit_action.setIcon(QIcon(':/quit_icon.png'))
    ...
    self.tray.setIcon(QIcon(":/lolik_main_icon.png"))
