...
def collapseExpandeWindow(self):
    if self.flagCollapseExpandWindow == 0:
        ...
        self.btn_start.setIcon(QIcon(':/start_icon.png'))
        ...
        self.btn_break.setIcon(QIcon(':/break_icon.png'))
        ...
        self.btn_long_break.setIcon(QIcon(':/long_break_icon.png'))
        ...
        self.btn_cancel.setIcon(QIcon(':/cancel_icon.png'))
        ...
        self.btn_collapse_expand.setIcon(QIcon(':/expand_icon.png'))
    ...
    # ---------- expand window ----------
        ...
        self.btn_collapse_expand.setText("")
        self.btn_collapse_expand.setToolTip("Collapse/Expand Window")
        self.btn_collapse_expand.setIcon(QIcon(':/collapse_icon.png'))
