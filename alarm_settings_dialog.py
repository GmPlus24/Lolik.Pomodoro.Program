...
def myAlarmSettingsDialog(self):
    ...
    self.alarm_settings_dialog.setWindowIcon(QIcon(":/settings_icon.png"))
    ...
    self.dialog_btn_play_sound_1.setIcon(QIcon(':/start_icon.png'))
    ...
    self.dialog_btn_stop_sound_1.setIcon(QIcon(':/stop_icon.png'))
    ...
    self.dialog_btn_play_sound_2.setIcon(QIcon(':/start_icon.png'))
    ...
    self.dialog_btn_stop_sound_2.setIcon(QIcon(':/stop_icon.png'))
    ...
    self.dialog_btn_play_sound_3.setIcon(QIcon(':/start_icon.png'))
    ...
    self.dialog_btn_stop_sound_3.setIcon(QIcon(':/stop_icon.png'))
    ...
    if user_sound == "Ring Sound Effect":
        self.effect1.setSource(QUrl.fromLocalFile(":/ring_sound_effect.wav"))
        self.start_sound = 0
    if user_sound == "Emergency Alarm":
        self.effect1.setSource(QUrl.fromLocalFile(":/emergency_alarm.wav"))
        self.start_sound = 1
    if user_sound == "Data Scaner":
        self.effect1.setSource(QUrl.fromLocalFile(":/data_scaner.wav"))
        self.start_sound = 2
    if user_sound == "Security Facility Breach Alarm":
        self.effect1.setSource(QUrl.fromLocalFile(":/security_facility_breach_alarm.wav"))
        self.start_sound = 3
    if user_sound == "Smartphone Ringtone":
        self.effect1.setSource(QUrl.fromLocalFile(":/smartphone_ringtone.wav"))
        self.start_sound = 4
        
        
    user_sound2 = self.dialog_combobox_break_sound.currentText()
    if user_sound2 == "Ring Sound Effect":
        self.effect2.setSource(QUrl.fromLocalFile(":/ring_sound_effect.wav"))
        self.break_sound = 0
    if user_sound2 == "Emergency Alarm":
        self.effect2.setSource(QUrl.fromLocalFile(":/emergency_alarm.wav"))
        self.break_sound = 1
    if user_sound2 == "Data Scaner":
        self.effect2.setSource(QUrl.fromLocalFile(":/data_scaner.wav"))
        self.break_sound = 2
    if user_sound2 == "Security Facility Breach Alarm":
        self.effect2.setSource(QUrl.fromLocalFile(":/security_facility_breach_alarm.wav"))
        self.break_sound = 3
    if user_sound2 == "Smartphone Ringtone":
        self.effect2.setSource(QUrl.fromLocalFile(":/smartphone_ringtone.wav"))
        self.break_sound = 4
    
    
    user_sound3 = self.dialog_combobox_long_break_sound.currentText()
    if user_sound3 == "Ring Sound Effect":
        self.effect3.setSource(QUrl.fromLocalFile(":/ring_sound_effect.wav"))
        self.long_break_sound = 0
    if user_sound3 == "Emergency Alarm":
        self.effect3.setSource(QUrl.fromLocalFile(":/emergency_alarm.wav"))
        self.long_break_sound = 1
    if user_sound3 == "Data Scaner":
        self.effect3.setSource(QUrl.fromLocalFile(":/data_scaner.wav"))
        self.long_break_sound = 2
    if user_sound3 == "Security Facility Breach Alarm":
        self.effect3.setSource(QUrl.fromLocalFile(":/security_facility_breach_alarm.wav"))
        self.long_break_sound = 3
    if user_sound3 == "Smartphone Ringtone":
        self.effect3.setSource(QUrl.fromLocalFile(":/smartphone_ringtone.wav"))
...
def dialog_play_1(self):
    ...
    if test_user_sound == "Ring Sound Effect":
        self.userTestEffect.setSource(QUrl.fromLocalFile(":/ring_sound_effect.wav"))
    if test_user_sound == "Emergency Alarm":
        self.userTestEffect.setSource(QUrl.fromLocalFile(":/emergency_alarm.wav"))
    if test_user_sound == "Data Scaner":
        self.userTestEffect.setSource(QUrl.fromLocalFile(":/data_scaner.wav"))
    if test_user_sound == "Security Facility Breach Alarm":
        self.userTestEffect.setSource(QUrl.fromLocalFile(":/security_facility_breach_alarm.wav"))
    if test_user_sound == "Smartphone Ringtone":
        self.userTestEffect.setSource(QUrl.fromLocalFile(":/smartphone_ringtone.wav"))
